...
**Does this app collect or share any of the following user data?**

All answers: **No data collected**

- Location: No
- Personal info (name, email, user ID): No
- Financial info: No
...
- Calendar: No
- Contacts: No
- App activity (search history, browsing history, installs, interactions): No
- Web browsing: No
- App info and performance (crash logs, diagnostics, performance data): No
- Device or other IDs: No

**Data is encrypted in transit?** — Not applicable (no data transmitted to us)
**You can request that data be deleted?** — Not applicable (no data collected)
